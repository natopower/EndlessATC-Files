...
<html lang="en">
  ...
  <ul>
    ...
    <li><strong>CYEG</strong> — Edmonton International Airport, Edmonton, AB</li>
  </ul>
  ...
  <h2>About</h2>
  <p>
    These files are built for the <em>Endless ATC</em> custom airport system. Install them and you’ll be able to play
    CYWG or CYEG with the airport/airspace configuration defined in each file. Both files are updated with the latest STARs and approach data as of January 2026.
  </p>
